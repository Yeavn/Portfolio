...
export const metadata: Metadata = {
  ...
  description:
    "Erfahren Sie in unserer Datenschutzerklärung, welche Daten wir erheben, wie wir sie verwenden und welche Rechte Sie haben. Ihre Privatsphäre ist uns wichtig.",
  robots: {
    index: false,
    follow: true,
  },
    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-[#1E1E1E] py-24 px-4">
      <div className="w-full max-w-2xl bg-[#353535] p-8 rounded-lg shadow-lg">
        ...
        <div className="text-[#C1C1C1] space-y-4 text-base leading-relaxed">
          ...
          <p>
            <strong>2. Datenerfassung auf dieser Website</strong>
            <br />
          ...
          <p>
            <strong>3. Wofür nutzen wir Ihre Daten?</strong>
            <br />
          ...
          <p className="text-xs text-[#878787]">
            Diese Datenschutzerklärung wurde nach bestem Wissen erstellt und
